package br.com.bios.aws_project01.service;

import br.com.bios.aws_project01.enums.EventType;
import br.com.bios.aws_project01.model.Envelope;
import br.com.bios.aws_project01.model.Product;
import br.com.bios.aws_project01.model.ProductEvent;
    ...
    public void publishProductEvent(Product product, EventType eventType, String username){
        ...
        try {
            ...
            LOG.info("Product event sent - Event: {} - ProductId: {} - MessageId: {}",
                    envelope.getEventType(), product.getId(), publishResult.getMessageId());
