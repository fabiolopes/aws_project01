package br.com.bios.aws_project01.consumer;

import br.com.bios.aws_project01.model.Invoice;
import br.com.bios.aws_project01.model.SnsMessage;
...
public class InvoiceConsumer {
    ...
    public void receiveS3Event(TextMessage textMessage) throws JMSException, IOException {
        ...
        proccessInvoiceNotification(s3EventNotification);
    }

    private void proccessInvoiceNotification(S3EventNotification s3EventNotification) throws IOException {
